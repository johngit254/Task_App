window.addEventListener("load", () => {
  ...
  form.addEventListener("submit", (e) => {
    ...
    // Validate that the task being entered is not blank or null
    if (!input.value) {
    ...
    const task_el_wrapper = document.createElement("li");

    const task_el = document.createElement("div");
    task_el.classList.add("task");

    task_el_wrapper.appendChild(task_el);
    ...
    list_el.appendChild(task_el_wrapper);
